                                    ...
                                    @else
                                        <li class="list-group-item">Đây là ngôn ngữ phụ của MENU: <br>
                                            @if (isset($record) && $record->langParent && $record->langParent->langs)
                                                <a
                                                    href="{{ route('admin.category.edit', $record->langParent->id) }}">{{ $record->langParent->langs->name }}</a>
                                            @else
...
<script>
    ...
    function goToEdit(id) {
        window.location.href = '{{ route('admin.category.edit', 'idx') }}'.replace(/idx/, id)
    }
