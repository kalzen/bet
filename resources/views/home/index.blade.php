                                ...
                                <div class="booker-wrapper row g-0 align-items-center justify-content-evenly py-0 ps-3">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-3 text-end pe-3">
                                        @if (Session::get('locale') == 'en')
                                            <a href="{{ route('booker.detail.no-lang', ['alias' => $booker->id]) }}" class="prd-btn-1">
                                                <small class="text-small" style="white-space: nowrap;">{{ __('home.view') }}</small>
                                            </a>
                                        @else
                                            <a href="{{ route('booker.detail', [ 'locale_code' => Session::get('locale'), 'alias' => $booker->id]) }}" class="prd-btn-1">
                                                <small class="text-small" style="white-space: nowrap;">{{ __('home.view') }}</small>
                                            </a>
                                        @endif
                    ...
                    <div class="row d-md-flex justify-content-evenly align-items-center">
                        ...
                        <div class="col-md-3 border-start border-end">
                            <div class="d-flex justify-content-around align-items-center">
                                <img src="{{ $tip->logo_team_1 }}" alt="Team 1" class="me-2" width="30"
                                    height="30">
                                <span class="w-75">{{ $langTip->name_team_1 }}</span>
                                <span>{{ $tip->score_team_1 }}</span>
                            </div>
                            <div class="d-flex justify-content-around align-items-center mt-2">
                                <img src="{{ $tip->logo_team_2 }}" alt="Team 2" class="me-2" width="30"
                                    height="30">
