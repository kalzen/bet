                    ...
                    <div class="order-3 col-span-12 grid grid-cols-1 gap-8 lg:order-2 lg:col-span-8 lg:row-span-2 lg:grid-cols-3 xl:col-span-9"
                        ...
                        <div class="lg:order-2 lg:col-span-2 flex flex-col gap-8">
                            ...
                            @foreach ($posts as $post)
                                ...
                                @endif
                                <div class="{{ $loop->index == 2 ? 'post-hide' : '' }}">
                                    <a href="{{ route('post.detail', ['alias' => $post->slug]) }}"
                                        ...
                                        <div class="flex flex-col py-1 xl:order-1">
                                            ...
                                            <div class="mt-2 text-xs text-gray-40" data-bt="tiles-any-cpt-lg-author">
                        ...
                        <div class="lg:order-1 flex flex-col gap-8">
                            ...
                            <div class="">
                                <a href="{{ route('post.detail', ['alias' => $post->slug]) }}"
                                    title="{{ $post->title }}"
                                    class="post-border grid lg:grid-cols-1 gap-3 max-lg:grid max-lg:grid-cols-[165px,auto] max-lg:gap-3 group !no-underline {{ $loop->index > 3 ? ' lg:border-solid lg:border-t-2 lg:border-black lg:pt-8' : '' }}"
                                    style="
                                        border: none;
                                        border-top: 2px solid black;"
                                    ...
                                    <img sizes="360px"
                                        src="{{ $post->images->first()->url ?? 'https://via.placeholder.com/150x100' }}"
                                        alt="Bet365 Enters the Ninth State for Sports Betting" width="300"
                                        height="169"
                                        class="object-cover object-center bg-cover bg-center aspect-square h-auto max-lg:max-h-40 w-full lg:aspect-video"
                                        style=" " loading="lazy">
                                    <div class="flex flex-col py-1 lg:order-1">
                                        ...
                                        <div class="mt-2 text-xs text-gray-40" data-bt="tiles-any-cpt-md-author">
                                            {{ __('post.list.by') . ' '. $post->user->name }}
                                        </div>
                                    </div>
                                </a>
                    ...
                    <div class="post-border order-4 col-span-12 gap-8 articles lg:order-3 lg:col-span-4 lg:border-b-2 lg:border-solid lg:border-black lg:pb-8 xl:col-span-3"
                        ...
                        <a href="{{ route('post.detail', ['alias' => $post->slug]) }}"
                            ...
                            <div class="flex items-center gap-2 text-xs text-gray-40">
                                <span class="font-semibold text-red-100" data-bt="tiles-news-xs-label">{{ $post->categories->first()->name ?? __('post.list.uncategorized') }}</span>
                                •
                                <span data-bt="tiles-news-xs-published-at">{{ $post->created_at->diffForHumans() }}</span>
                            </div>
                    ...
                    <div class="order-3 col-span-12 sport-books lg:col-span-4 lg:order-4 xl:col-span-3"
                        ...
                        <div class="mt-3 flex flex-col gap-2">
                            ...
                            <a href="{{ route('booker.detail', $booker->id) }}" target="_blank" rel="nofollow noopener"
                                ...
                                <img sizes="120px" src="{{ $booker->image }}"
                                    alt="{{ $booker->name }}" width="120" height="62"
